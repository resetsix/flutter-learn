...
Future<SuggestionResultRes> getInvogueResultListService() async {
  return SuggestionResultRes.fromJson(await fetch.get(HttpConf.IN_VOGUE_LIST));
}

Future<SuggestionResultRes> getOnsstopResultListService() async {
  return SuggestionResultRes.fromJson(await fetch.get(HttpConf.ONE_STOP_LIST));
}

Future<List<HomeRecommendRes>> getHomeRecommendListService(
  Map<String, dynamic> params,
) async {
  return (await fetch.get(HttpConf.HOME_RECOMMEND_LIST, params: params) as List)
      .map((item) {
